	...
	<div id="sideMenu">
		...
		<c:forEach var="c" items="${cs }">
			<div class="panel _sidePanel">
				...
				<ul id="menu1" class="nav _navlist collapse" data-courseid="${c.id }">
					<li><a href="/TeacherServlet" data-item="courseInfo" target="S">课程信息</a></li>
					<li><a href="/TeacherServlet" data-item="courseware" target="S">课件管理</a></li>
					<li><a href="/TeacherServlet" data-item="video" target="S" >视频管理</a></li>
					<li><a href="/TeacherServlet" data-item="task" target="S" >作业管理</a></li>
					<li><a href="/TeacherServlet" data-item="comunicate" target="S">互动交流</a></li>
					<li><a href="/TeacherServlet" data-item="FAQ" target="S" >FAQ</a></li>
				</ul>
			</div>
		</c:forEach>
	</div>
